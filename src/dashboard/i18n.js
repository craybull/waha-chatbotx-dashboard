...
const TRANSLATIONS = {
  ...
  en: {
    ...
    // Step 1: Webhook
    step1_title: "Step 1: Create Channel on ChatbotX",
    step1_desc: "Paste this URL into Callback URL field on ChatbotX",
    step1_label: "Callback URL for session:",
    step1_channel_name_label: "Channel Name (Name):",
    step1_auto_detect: "Auto-detected from WhatsApp",
    step1_callback_url_label: "Callback URL (This Channel):",
    step1_dedicated_route: "Dedicated route for this number",
    step1_btn_copy: "Copy",
    step1_copied: "Copied!",
    step1_note: "Receives messages from ChatbotX and routes directly to this WhatsApp number.",

    // Step 2: ChatbotX Config
    step2_title: "Step 2: Link ChatbotX Channel",
    step2_subtitle: "Paste Channel API Token generated from ChatbotX",
    step2_desc: "Synchronize incoming WhatsApp messages to your ChatbotX Inbox & Automation bot.",
    step2_token_label: "ChatbotX API Token:",
    step2_token_sub: "Obtain after clicking Create",
    step2_token_placeholder: "Paste Channel Token from ChatbotX here...",
    step2_token_hint: "Paste Channel API Token generated from ChatbotX",
    step2_api_url_label: "ChatbotX API URL:",
    step2_media_url_label: "Media & Webhook Base URL:",
    step2_media_url_sub: "Your Domain",
    step2_include_groups: "Forward WhatsApp group messages to ChatbotX",
    step2_btn_save: "Save & Activate Channel",
    step2_saving: "Saving...",
    step2_status_active: "Linked",
    step2_status_inactive: "Not Linked",
    step2_status_disabled: "Disabled",

    // Step 3: Auth & QR
    step3_title: "Connect WhatsApp Account",
    step3_desc: "Scan QR code or use Phone Pairing Code",
    step3_tab_qr: "QR Code",
    step3_tab_pairing: "Phone Pairing Code",
    step3_qr_instructions: "Open WhatsApp on your phone > Settings > Linked Devices > Link a Device > Scan QR",
    step3_qr_auto_refresh: "QR code refreshes automatically when unlinked",
    step3_qr_loading: "Loading QR Code...",
    step3_pairing_subheader: "Link with Phone Number",
    step3_phone_label: "WhatsApp Phone Number:",
    step3_phone_placeholder: "e.g. 14155552671",
    step3_phone_hint: "Country Code + Phone without leading 0 (e.g. 14155552671).",
    step3_btn_request_code: "Get Code",
    step3_pairing_code_label: "Enter this 8-digit code into WhatsApp on your phone:",
    step3_pairing_step_instructions: "Open WhatsApp > Linked Devices > Link with phone number > Enter the code above.",
  ...
  vi: {
    ...
    // Step 1: Webhook
    step1_title: "Bước 1: Tạo Kênh trên ChatbotX",
    step1_desc: "Copy thông tin tự động sang ChatbotX",
    step1_label: "Callback URL cho tài khoản:",
    step1_channel_name_label: "Tên Kênh (Name):",
    step1_auto_detect: "Tự động nhận diện từ WhatsApp",
    step1_callback_url_label: "Callback URL (Kênh này):",
    step1_dedicated_route: "Định tuyến riêng cho số này",
    step1_btn_copy: "Sao chép",
    step1_copied: "Đã chép!",
    step1_note: "Nhận tin nhắn phản hồi từ ChatbotX và gửi trực tiếp qua số WhatsApp này.",

    // Step 2: ChatbotX Config
    step2_title: "Bước 2: Kích hoạt Kênh tại đây",
    step2_subtitle: "Dán mã API Token sinh ra từ ChatbotX",
    step2_desc: "Đồng bộ tin nhắn WhatsApp đến vào Hộp thư & Kịch bản AI ChatbotX của bạn.",
    step2_token_label: "ChatbotX API Token:",
    step2_token_sub: "Lấy sau khi bấm Create",
    step2_token_placeholder: "Dán mã Token vào đây...",
    step2_token_hint: "Lấy Token: Mở ChatbotX > Kênh > Chọn / Tạo Kênh > Sao chép API Token",
    step2_api_url_label: "ChatbotX API URL:",
    step2_media_url_label: "Media & Webhook Base URL:",
    step2_media_url_sub: "Domain của bạn",
    step2_include_groups: "Bao gồm tin nhắn từ Nhóm WhatsApp (Groups)",
    step2_btn_save: "Lưu & Kích hoạt Kênh",
    step2_saving: "Đang lưu...",
    step2_status_active: "Đã liên kết",
    step2_status_inactive: "Chưa liên kết",
    step2_status_disabled: "Tạm tắt",

    // Step 3: Auth & QR
    step3_title: "Kết nối Số WhatsApp",
    step3_desc: "Quét mã QR hoặc Nhận mã Ghép nối (Pairing Code)",
    step3_tab_qr: "Mã QR",
    step3_tab_pairing: "Mã số (Phone)",
    step3_qr_instructions: "Mở WhatsApp trên điện thoại > Cài đặt > Thiết bị liên kết > Liên kết thiết bị > Quét mã QR",
    step3_qr_auto_refresh: "Mã QR tự động làm mới mỗi 20 giây khi chưa quét",
    step3_qr_loading: "Đang tải mã QR...",
    step3_pairing_subheader: "Liên kết bằng Số điện thoại",
    step3_phone_label: "Số điện thoại WhatsApp:",
    step3_phone_placeholder: "ví dụ: 84384524243",
    step3_phone_hint: "Mã quốc gia + SĐT bỏ số 0 đầu (ví dụ: 84384524243).",
    step3_btn_request_code: "Lấy mã",
    step3_pairing_code_label: "Mã ghép nối của bạn (nhập vào WhatsApp trong 60 giây):",
    step3_pairing_step_instructions: "Mở WhatsApp > Thiết bị liên kết > Liên kết bằng số điện thoại > Nhập mã trên.",
  ...
  id: {
    ...
    // Step 1: Webhook
    step1_title: "Langkah 1: Buat Saluran di ChatbotX",
    step1_desc: "Salin data ini ke formulir Saluran ChatbotX",
    step1_label: "Callback URL untuk akun:",
    step1_channel_name_label: "Nama Saluran (Name):",
    step1_auto_detect: "Otomatis terdeteksi dari WhatsApp",
    step1_callback_url_label: "Callback URL (Saluran ini):",
    step1_dedicated_route: "Rute khusus untuk nomor ini",
    step1_btn_copy: "Salin",
    step1_copied: "Tersalin!",
    step1_note: "Menerima pesan balasan dari ChatbotX dan mengirimkannya langsung melalui nomor WhatsApp ini.",

    // Step 2: ChatbotX Config
    step2_title: "Langkah 2: Tautkan Saluran ChatbotX",
    step2_subtitle: "Tempel API Token Saluran dari ChatbotX di sini",
    step2_desc: "Sinkronkan pesan WhatsApp masuk ke Kotak Masuk & Otomatisasi AI ChatbotX Anda.",
    step2_token_label: "API Token ChatbotX:",
    step2_token_sub: "Dapatkan setelah klik Create",
    step2_token_placeholder: "Tempel API Token Saluran dari ChatbotX di sini...",
    step2_token_hint: "Dapatkan Token: Buka ChatbotX > Saluran > Pilih / Buat Saluran > Salin API Token",
    step2_api_url_label: "URL API ChatbotX:",
    step2_media_url_label: "Media & Webhook Base URL:",
    step2_media_url_sub: "Domain Anda",
    step2_include_groups: "Teruskan pesan grup WhatsApp ke ChatbotX",
    step2_btn_save: "Simpan & Aktifkan Saluran",
    step2_saving: "Menyimpan...",
    step2_status_active: "Tertaut",
    step2_status_inactive: "Belum Tertaut",
    step2_status_disabled: "Dinonaktifkan",

    // Step 3: Auth & QR
    step3_title: "Hubungkan Nomor WhatsApp",
    step3_desc: "Pindai kode QR atau gunakan kode penyandingan nomor telepon",
    step3_tab_qr: "Kode QR",
    step3_tab_pairing: "Kode Nomor (Telepon)",
    step3_qr_instructions: "Buka WhatsApp di ponsel Anda > Pengaturan > Perangkat Tertaut > Tautkan Perangkat > Pindai QR",
    step3_qr_auto_refresh: "Kode QR otomatis disegarkan setiap 20 detik jika belum dipindai",
    step3_qr_loading: "Memuat kode QR...",
    step3_pairing_subheader: "Tautkan dengan Nomor Telepon",
    step3_phone_label: "Nomor Telepon WhatsApp:",
    step3_phone_placeholder: "contoh: 6281234567890",
    step3_phone_hint: "Kode Negara + Nomor Telepon tanpa angka 0 di depan (contoh: 6281234567890).",
    step3_btn_request_code: "Minta Kode",
    step3_pairing_code_label: "Masukkan kode 8 digit ini ke aplikasi WhatsApp di ponsel Anda:",
    step3_pairing_step_instructions: "Buka WhatsApp > Perangkat Tertaut > Tautkan dengan nomor telepon > Masukkan kode di atas.",
  ...
  pt: {
    ...
    // Step 1: Webhook
    step1_title: "Etapa 1: Criar Canal no ChatbotX",
    step1_desc: "Copie estas informações para o ChatbotX",
    step1_label: "Callback URL para a conta:",
    step1_channel_name_label: "Nome do Canal (Name):",
    step1_auto_detect: "Detectado automaticamente pelo WhatsApp",
    step1_callback_url_label: "Callback URL (Deste Canal):",
    step1_dedicated_route: "Rota dedicada para este número",
    step1_btn_copy: "Copiar",
    step1_copied: "Copiado!",
    step1_note: "Recebe mensagens do ChatbotX e encaminha diretamente por este número do WhatsApp.",

    // Step 2: ChatbotX Config
    step2_title: "Etapa 2: Vincular Canal ChatbotX",
    step2_subtitle: "Cole o Token de API do ChatbotX aqui",
    step2_desc: "Sincronize mensagens do WhatsApp com a Caixa de Entrada e fluxos de IA do ChatbotX.",
    step2_token_label: "Token de API ChatbotX:",
    step2_token_sub: "Obtenha após clicar em Create",
    step2_token_placeholder: "Cole o Token de API do ChatbotX aqui...",
    step2_token_hint: "Obter Token: Abra o ChatbotX > Canais > Selecionar / Criar Canal > Copiar Token de API",
    step2_api_url_label: "URL da API ChatbotX:",
    step2_media_url_label: "Media & Webhook Base URL:",
    step2_media_url_sub: "Seu Domínio",
    step2_include_groups: "Encaminhar mensagens de grupos do WhatsApp para o ChatbotX",
    step2_btn_save: "Salvar e Ativar Canal",
    step2_saving: "Salvando...",
    step2_status_active: "Vinculado",
    step2_status_inactive: "Não Vinculado",
    step2_status_disabled: "Desativado",

    // Step 3: Auth & QR
    step3_title: "Conectar Conta WhatsApp",
    step3_desc: "Escaneie o código QR ou utilize o código de pareamento por telefone",
    step3_tab_qr: "Código QR",
    step3_tab_pairing: "Código de Pareamento",
    step3_qr_instructions: "Abra o WhatsApp no celular > Configurações > Dispositivos Conectados > Conectar Dispositivo > Escanear QR",
    step3_qr_auto_refresh: "O código QR é atualizado automaticamente a cada 20 segundos se não for escaneado",
    step3_qr_loading: "Carregando código QR...",
    step3_pairing_subheader: "Vincular com Número de Telefone",
    step3_phone_label: "Número de Telefone do WhatsApp:",
    step3_phone_placeholder: "ex: 5511999999999",
    step3_phone_hint: "Código do País + DDD + Número sem o 0 inicial (ex: 5511999999999).",
    step3_btn_request_code: "Solicitar Código",
    step3_pairing_code_label: "Digite este código de 8 dígitos no WhatsApp em seu celular:",
    step3_pairing_step_instructions: "Abra o WhatsApp > Dispositivos Conectados > Conectar com número de telefone > Digite o código acima.",
