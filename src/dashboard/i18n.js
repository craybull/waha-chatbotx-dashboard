...
const TRANSLATIONS = {
  ...
  en: {
    ...
    toast_connected_success: "WhatsApp account connected successfully!",
  ...
  vi: {
    ...
    toast_connected_success: "Đã kết nối tài khoản WhatsApp thành công!",
  ...
  id: {
    ...
    toast_connected_success: "Akun WhatsApp berhasil terhubung!",
  ...
  pt: {
    ...
    toast_connected_success: "Conta do WhatsApp conectada com sucesso!",
